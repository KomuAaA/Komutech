...
// 配置
const CONFIG = {
    id: "KOMUTECH_L_WD_ZHTMS",
    southMachineId: "KOMUTECH_L_JQ_LXFZCZQ",
    time: 15000,
    interval: 3000,
    maxEmptyChecks: 5,
    outputId: "KOMUTECH_L_FZ_造化灵曦",
    outputSlots: [15, 16, 24, 25, 33, 34],
    rules: [
        {itemId: "KOMUTECH_L_FZ_WZJGFZ", start: 0, end: 4},
        {itemId: "KOMUTECH_L_FZ_WZLJFZ", start: 9, end: 13},
        {itemId: "KOMUTECH_L_FZ_WZSYFZ", start: 18, end: 22},
        {itemId: "KOMUTECH_L_FZ_WZKJFZ", start: 27, end: 31},
        {itemId: "KOMUTECH_L_FZ_WZSLFZ", start: 36, end: 40}
    ]
};
...
function process(loc, player, now, state) {
    ...
    if (!state.timer.half && elapsed >= CONFIG.time / 2) {
        player.sendMessage(ChatColor.YELLOW + "造化汇聚");
