...
const CONFIG = {
    ...
    interval: 3000,
    maxEmptyChecks: 5,
    outputId: "KOMUTECH_L_FZ_五行灵曦",
    outputSlots: [15, 16, 24, 25, 33, 34],
    rules: [
        {itemId: "KOMUTECH_L_FZ_WZJYSFZ", start: 0, end: 4},
        {itemId: "KOMUTECH_L_FZ_WZMYSFZ", start: 9, end: 13},
        {itemId: "KOMUTECH_L_FZ_WZSYSFZ", start: 18, end: 22},
        {itemId: "KOMUTECH_L_FZ_WZHYSFZ", start: 27, end: 31},
        {itemId: "KOMUTECH_L_FZ_WZTYSFZ", start: 36, end: 40}
    ]
};
...
function process(loc, player, now, state) {
    ...
    if (!state.timer.half && elapsed >= CONFIG.time / 2) {
        player.sendMessage(ChatColor.YELLOW + "五行汇聚");
